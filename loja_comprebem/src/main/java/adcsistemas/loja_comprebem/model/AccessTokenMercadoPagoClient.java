...
@Entity
@Table(name = "access_token_mercado_pago_client")
@SequenceGenerator(name = "seq_access_token_mercado_pago_client", sequenceName = "seq_access_token_mercado_pago_client", allocationSize = 1, initialValue = 1)
public class AccessTokenMercadoPagoClient implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_access_token_mercado_pago_client")
	private Long id;
