...
public class NotaFiscalCompra implements Serializable {
	...
	@NotNull(message = "Número da nota é obrigatória")
	...
	@NotNull(message = "Valor Total da nota é obrigatória")
	@Column(nullable = false)
	private BigDecimal valorTotal;

	private BigDecimal valorDesconto;

	@NotNull(message = "Valor do Icms da nota é obrigatória")
	@Column(nullable = false)
	...
	private Empresa pessoaFornecedor;
	...
	public Empresa getPessoaFornecedor() {
		return pessoaFornecedor;
	}

	public void setPessoaFornecedor(Empresa pessoaFornecedor) {
