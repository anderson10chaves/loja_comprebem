...
public class CobrancaGeradaSaasDataDTO implements Serializable {
	...
	private String duplicatedPayment;
	
	private boolean postalService = false;
	
	
	private CobrancaGeradaSaasDiscountDTO discount = new CobrancaGeradaSaasDiscountDTO();
	private CobrancaGeradaSaasFineDTO fine = new CobrancaGeradaSaasFineDTO();
	private CobrancaGeradaInterestDTO interest = new CobrancaGeradaInterestDTO();
	...
	public String getDuplicatedPayment() {
		return duplicatedPayment;
	}
	public void setDuplicatedPayment(String duplicatedPayment) {
	...
	public CobrancaGeradaSaasDiscountDTO getDiscount() {
		return discount;
	}
	public void setDiscount(CobrancaGeradaSaasDiscountDTO discount) {
		this.discount = discount;
	}
	public CobrancaGeradaSaasFineDTO getFine() {
		return fine;
	}
	public void setFine(CobrancaGeradaSaasFineDTO fine) {
		this.fine = fine;
	}
	public CobrancaGeradaInterestDTO getInterest() {
		return interest;
	}
	public void setInterest(CobrancaGeradaInterestDTO interest) {
